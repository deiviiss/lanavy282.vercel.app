    ...
    <header className="bg-card shadow-md sticky top-0 z-40">
      <div className="container mx-auto px-2 sm:px-4 relative">
        ...
        <div className="md:hidden absolute right-0 sm:right-1/3 bottom-0">
          {selectedBranch
            ? (
              <Button variant="ghost" size="sm" onClick={handleChangeBranch} className="flex items-center gap-1 px-2 group-hover:bg-red-50 transition-colors">
                <MapPin className="h-4 w-4 text-primary hover:text-red-500" />
